...
void MainWindow::ShowDockWidget()
{
    ...
    // 设定主窗口
    QTextEdit * pTextEdit = new QTextEdit("Main Window", this);
    setCentralWidget(pTextEdit);

    // 设定第一个浮动窗口
    QDockWidget * pDockWidget = new QDockWidget("DockWidget1", this);
    ...
    QTextEdit * pTextEdit1 = new QTextEdit("Text1", this);
    pDockWidget->setWidget(pTextEdit1);
    addDockWidget(Qt::RightDockWidgetArea, pDockWidget);

    // 第二个浮动窗口
    QDockWidget * pDockWidget2 = new QDockWidget("DockWidget2", this);
    ...
    QTextEdit * pTextEdit2 = new QTextEdit("Text2", this);
    pDockWidget2->setWidget(pTextEdit2);
    addDockWidget(Qt::RightDockWidgetArea, pDockWidget2);

    // 第san三个浮动窗口
    QDockWidget * pDockWidget3 = new QDockWidget("DockWidget3", this);
    ...
    QTextEdit * pTextEdit3 = new QTextEdit("Text3", this);
    pDockWidget3->setWidget(pTextEdit3);
    addDockWidget(Qt::RightDockWidgetArea, pDockWidget3);
}
```

![1621872317127](images/1621872317127.png)
...
void StackedWidget::ShowStackedWidget()
{
    QListWidget * list = new QListWidget(this);  //新建一个QListWidget对象
    list->insertItem(0, ("window1"));  //插入三个条目
    list->insertItem(1, ("window2"));
    list->insertItem(2, ("window3"));

    QLabel * label1 = new QLabel(("windowTest1"));  //新建三个标签对象，作为堆栈窗口需要显示的三层窗体
    QLabel * label2 = new QLabel(("windowTest2"));
    QLabel * label3 = new QLabel(("windowTest3"));

    QStackedWidget* stack = new QStackedWidget(this);  //新建一个堆栈窗体对象
    stack->addWidget(label1);  //将新建的三个QLabel标签控件依次插入堆栈窗体中
    ...
    mainLayout->setStretchFactor(list, 1);  //设置list为可伸缩控件
